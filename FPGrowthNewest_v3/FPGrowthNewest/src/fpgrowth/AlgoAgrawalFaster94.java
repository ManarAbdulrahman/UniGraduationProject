...
public class AlgoAgrawalFaster94{
    ...
    // string keep the name not is number from input file
    protected Map<String,String> mapName = new HashMap<String, String>();
    ...
    public AlgoAgrawalFaster94(Map<String,String> fixN){
        mapName = fixN;
    }
     ...
     */
    public void runAlgorithm(Itemsets patterns, String output, int databaseSize, double minconf) throws IOException {
        // save the parameters
        ...
        // start the algorithm
        runAlgorithm(patterns, output, databaseSize);
    }
     ...
     * @throws IOException exception if error writing to the output file
     */
    public void runAlgorithm(Itemsets patterns, String output, int databaseSize, double minconf,
     ...
     */
    private void runAlgorithm(Itemsets patterns, String output, int databaseSize) throws IOException {
    ...
    protected void saveRule(int[] itemset1, int supportItemset1, int[] itemset2, int supportItemset2,
        ...
        if(writer != null){
            ...
            for (int i = 0; i < itemset1.length; i++) {
                String itemN = mapName.get(Integer.toString(itemset1[i]));
                buffer.append(itemN);
            ...
            for (int i = 0; i < itemset2.length; i++) {
                String itemN = mapName.get(Integer.toString(itemset2[i]));
                buffer.append(itemN);
